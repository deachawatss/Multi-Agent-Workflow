...
Multi-platform speech integration with unique voices per agent.

**Linux** (espeak-ng):
| Agent | Voice | Rate |
|-------|-------|------|
| Main | en-us+f3 | 195 |
| Agent 1 | en-gb+m3 (British) | 220 |
| Agent 2 | en-au+f2 (Australian) | 220 |
| Agent 3 | en-in+m2 (Indian) | 220 |
...
### Linux Users: Install Dependencies First
```bash
...
# Or manually install:
sudo apt-get update
sudo apt-get install espeak-ng libnotify-bin tmux jq

# See LINUX-SETUP.md for detailed instructions
```
